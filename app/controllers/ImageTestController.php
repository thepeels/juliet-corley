 ...
 * 
 * Normally you will never be creating and using Image object by themselves
 * - you will alway be creating them inside the FishBuilder and they will be
 * automatically re-constructed when you use Fish->getByName();.
 * 
 * So you will be doing things like $fish->large_image->download() etc...
 * 
 */
