...
<div class="container-24">
  ...
  <div class = "right-edge"></div>
    <div class="grid-24">
        ...
        <div class="grid-6 push-3 second-box ">
            <p class="segoe blue">
